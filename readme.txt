...
npx expo install
npx expo start
if you want clear cache you can use below command 
npx expo start -c
...
pip install tensorflow pillow flask requests
pip install tensorflow pillow flask
python preview_clean_dataset.py
...
npm install
npx expo start
# (Optional) npm install -g expo-cli
